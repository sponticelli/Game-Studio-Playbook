...
- **Why It Matters** — Context for live game operations
- **Framework** — Structured approach for improvement
- **Diagnostic Questions** — To surface hidden problems
- **Checklist** — Items to verify
- **Tasks** — Concrete optimization exercises
- **Notes Section** — Space for your findings
...
```
┌─────────────────────────────────────────────────────────────────────┐
│                    LIVE OPS MATURITY LEVELS                         │
├─────────────────────────────────────────────────────────────────────┤
│                                                                     │
│  LEVEL 5: OPTIMIZED                                                 │
│  ┌───────────────────────────────────────────────────────────────┐  │
│  │ AI-driven personalization, predictive systems, automated      │  │
│  │ optimization, real-time response                              │  │
│  └───────────────────────────────────────────────────────────────┘  │
│                               ▲                                     │
│  LEVEL 4: PERSONALIZED                                              │
│  ┌───────────────────────────────────────────────────────────────┐  │
│  │ Segment-based content and offers, A/B testing integrated,    │  │
│  │ data-driven decisions                                        │  │
│  └───────────────────────────────────────────────────────────────┘  │
│                               ▲                                     │
│  LEVEL 3: SYSTEMATIC                                                │
│  ┌───────────────────────────────────────────────────────────────┐  │
│  │ Regular event cadence, content calendar, remote config,      │  │
│  │ defined processes                                            │  │
│  └───────────────────────────────────────────────────────────────┘  │
│                               ▲                                     │
│  LEVEL 2: REACTIVE                                                  │
│  ┌───────────────────────────────────────────────────────────────┐  │
│  │ Ad-hoc events, manual processes, responding to issues,       │  │
│  │ basic analytics                                              │  │
│  └───────────────────────────────────────────────────────────────┘  │
│                               ▲                                     │
│  LEVEL 1: MINIMAL                                                   │
│  ┌───────────────────────────────────────────────────────────────┐  │
│  │ Bug fixes and maintenance only, no regular content,          │  │
│  │ no events                                                    │  │
│  └───────────────────────────────────────────────────────────────┘  │
│                                                                     │
└─────────────────────────────────────────────────────────────────────┘
...
Event cadence drives engagement—but more events isn't always better. Too frequent leads to fatigue and unsustainable production burden. Too sparse loses players to competitors. Optimizing cadence means finding the rhythm that maximizes engagement while being produceable.
...
|---|---|---|---|
|Event participation declining|>10% drop over 3 events||🟢🟡🔴|
|DAU lift decreasing|<50% of historical||🟢🟡🔴|
|Event-related spending down|>15% drop||🟢🟡🔴|
|Negative feedback mentions events|Increasing trend||🟢🟡🔴|
|"Event fatigue" in reviews|Any mentions||🟢🟡🔴|
...
Players need reasons to return. But new content is expensive. Content refresh strategies—rotating existing content, seasonal variations, difficulty progression—extend content life without full recreation costs. Smart refresh keeps the game feeling alive efficiently.

## Framework: Content Lifecycle Stages

```
        ┌─────────────┐
        │    NEW      │  Launch with fanfare, maximum engagement
        │             │
        └──────┬──────┘
               │
               ▼
        ┌─────────────┐
        │   ACTIVE    │  Regular rotation, strong engagement
        │             │
        └──────┬──────┘
               │
               ▼
        ┌─────────────┐
        │   MATURE    │  Less prominent, still engaged by some
        │             │
        └──────┬──────┘
               │
               ▼
        ┌─────────────┐
        │   LEGACY    │  Archive or sunset candidate
        │             │
        └─────────────┘
```
...
Intuition is unreliable. Teams confidently implement changes that hurt metrics or skip changes that would help. A/B testing turns opinions into evidence. But ad-hoc testing creates noise—a strategic roadmap ensures you're testing what matters and building cumulative knowledge.
...
**Prioritization Formula:** Impact × Confidence / Effort
...
Live games have live problems—server outages, exploit discoveries, content bugs, negative sentiment spikes. Without practiced incident response, teams panic, communication is confused, and recovery takes longer than necessary. Preparation reduces impact and builds player trust.
...
│   ┌───────────┐          ┌───────────┐          ┌───────────┐      │
│   │ Monitoring│────────▶ │ Severity  │────────▶ │ War Room  │      │
│   │ Player    │          │ Assessment│          │ Assembled │      │
│   │ Reports   │          │           │          │           │      │
│   └───────────┘          └───────────┘          └───────────┘      │
│                                                        │            │
│                                                        ▼            │
...
Live ops accumulates process debt. Manual tasks that should be automated, approvals that add time without value, meetings that don't produce decisions—all drain capacity from player-facing work. Regular efficiency audits reclaim time for improvement.
...
**ROI Calculation:** Development Hours / (Monthly Hours Saved × Months)
...
Mature games often leave revenue on the table—not through lack of monetization, but through unoptimized funnels, mispriced offers, and untargeted approaches. Systematic revenue optimization finds incremental gains without damaging player experience.

## Framework: Revenue Decomposition

```
Revenue = Installs × Conversion Rate × ARPPU

Where:
- Installs = DAU × Install Rate (or existing users)
...
├─────────────────────────────────────────────────────────────────────┤
│                                                                     │
│  WEEK -2 to -1: RETROSPECTIVE                                       │
│  ┌───────────────────────────────────────────────────────────────┐  │
│  │ Review past quarter metrics, learnings, successes, failures  │  │
│  └───────────────────────────────────────────────────────────────┘  │
│                                                                     │
│  WEEK 0: PLANNING                                                   │
│  ┌───────────────────────────────────────────────────────────────┐  │
│  │ Set goals, prioritize initiatives, allocate resources        │  │
│  └───────────────────────────────────────────────────────────────┘  │
│                                                                     │
│  WEEKS 1-12: EXECUTION                                              │
│  ┌───────────────────────────────────────────────────────────────┐  │
│  │ Monthly check-ins, adjust as needed, deliver content & events│  │
│  └───────────────────────────────────────────────────────────────┘  │
│                                                                     │
│  WEEK 13: ASSESSMENT                                                │
│  ┌───────────────────────────────────────────────────────────────┐  │
│  │ Measure results, prepare for retrospective                   │  │
│  └───────────────────────────────────────────────────────────────┘  │
│                                                                     │
└─────────────────────────────────────────────────────────────────────┘
```
