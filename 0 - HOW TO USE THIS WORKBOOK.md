...
This workbook exists to externalize the thinking that experienced game developers carry implicitly. It captures the questions you should ask, the frameworks that structure good decisions, and the checklists that prevent common failures—not as theory, but as practical tools you can deploy immediately.
...
│    ┌─────────────────┐         ┌─────────────────┐                  │
│    │    TRACK A      │         │    TRACK B      │                  │
│    │   Greenfield    │         │   Mature Game   │                  │
│    │  (Build Fresh)  │         │ (Audit & Align) │                  │
│    └─────────────────┘         └─────────────────┘                  │
│                                                                     │
└─────────────────────────────────────────────────────────────────────┘
```
...
```
Week 1-2:  Block 1 (Foundation) — Vision, business model, audience
Week 3-4:  Block 2 (Planning) — Milestones, prioritization, estimation
Week 5-6:  Block 3 (Team) — Roles, communication, knowledge management
Week 7-8:  Block 4 (Production) — Daily execution, quality gates
Week 9-10: Block 5 (Scope) — Change management, stakeholder alignment
Week 11-12: Block 6 (Risk) — Risk register, incident response
Week 13+:  Block 7 (Launch) — As you approach release
```
...
3. **Flag gaps** — topics where you have nothing or what you have isn't working
4. **Prioritize gaps** — which missing pieces are causing the most pain?
...
The ultimate goal is not to follow this workbook but to build your own **Studio Playbook**—a living document customized to your team, your games, and your way of working.
...
|---|---|---|---|---|
|1|Vision Statement|✓|Good|No|
|1|Business Model|✓|Outdated|Yes|
|2|Milestone Definitions|✗|N/A|Yes|
...
│  ─────────┼─────────────────┼──────────────────┼─────────────────  │
│           │                 │                  │                   │
│  HIGH     │  DO FIRST       │  DO SECOND       │  PLAN CAREFULLY   │
│  IMPACT   │  Quick wins     │  Core fixes      │  Strategic work   │
│           │                 │                  │                   │
│  ─────────┼─────────────────┼──────────────────┼─────────────────  │
│           │                 │                  │                   │
│  MEDIUM   │  DO SECOND      │  DO THIRD        │  CONSIDER         │
│  IMPACT   │  Easy value     │  Standard work   │  Worth it?        │
│           │                 │                  │                   │
│  ─────────┼─────────────────┼──────────────────┼─────────────────  │
│           │                 │                  │                   │
│  LOW      │  FILL GAPS      │  BACKLOG         │  SKIP             │
│  IMPACT   │  When time      │  Maybe later     │  Not worth it     │
│           │                 │                  │                   │
└─────────────────────────────────────────────────────────────────────┘
```
...
```
┌─────────────────────────────────────────────────────────────────────┐
│                    STUDIO PLAYBOOK STRUCTURE                         │
├─────────────────────────────────────────────────────────────────────┤
│                                                                     │
│  📁 FOUNDATION                                                      │
│  ├── 📄 Our Vision (what we're building and why)                    │
│  ├── 📄 Business Model (how we make money)                          │
│  ├── 📄 Target Audience (who we're building for)                    │
│  └── 📄 Success Metrics (how we know we're winning)                 │
│                                                                     │
│  📁 PLANNING                                                        │
│  ├── 📄 Milestone Definitions (what each phase means)               │
│  ├── 📄 Estimation Guidelines (how we size work)                    │
│  └── 📄 Roadmap Template (how we plan ahead)                        │
│                                                                     │
│  📁 TEAM                                                            │
│  ├── 📄 Role Definitions (who does what)                            │
│  ├── 📄 Decision Rights (who decides what)                          │
│  ├── 📄 Meeting Guide (our rituals and ceremonies)                  │
│  └── 📄 Communication Norms (how we talk to each other)             │
│                                                                     │
│  📁 EXECUTION                                                       │
│  ├── 📄 Definition of Done (when is work complete)                  │
│  ├── 📄 Task Standards (how we break down and track work)           │
│  └── 📄 Quality Gates (checks before shipping)                      │
│                                                                     │
│  📁 CHANGE MANAGEMENT                                               │
│  ├── 📄 Feature Request Process (how new ideas enter)               │
│  ├── 📄 Scope Change Protocol (how we handle changes)               │
│  └── 📄 Cut Criteria (how we decide what to drop)                   │
│                                                                     │
│  📁 RISK & RESPONSE                                                 │
│  ├── 📄 Risk Register (known risks and mitigations)                 │
│  ├── 📄 Incident Response (how we handle emergencies)               │
│  └── 📄 Retrospective Format (how we learn)                         │
│                                                                     │
│  📁 LIVE OPERATIONS (if applicable)                                 │
│  ├── 📄 Event Framework (how we run events)                         │
│  ├── 📄 Release Process (how we ship updates)                       │
│  └── 📄 On-Call Procedures (who watches the game)                   │
│                                                                     │
│  📁 ONBOARDING                                                      │
│  ├── 📄 Day 1 Checklist                                             │
│  ├── 📄 Week 1 Guide                                                │
...
│                                                                     │
│  📁 REFERENCE                                                       │
│  ├── 📄 Glossary (our terminology)                                  │
│  ├── 📄 Tool Guide (what we use and why)                            │
...
A stale playbook is worse than no playbook—it teaches people to ignore documentation.
...
**Assign ownership.** Every playbook section needs an owner responsible for keeping it current. This doesn't mean they write everything—they ensure it stays accurate.
...
The best game development process is the one your team actually follows. This workbook provides frameworks, but frameworks don't ship games—people do. The goal is to remove friction, surface problems early, and let talented people do their best work.

Use this workbook as a toolbox, not a textbook. Take what works, adapt what's close, and ignore what doesn't fit. The measure of success isn't workbook completion—it's whether your team ships better games with less pain.
